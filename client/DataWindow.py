...
from client.ui_data import Ui_Dialog

TableFields = {"Users": [[QLineEdit, "Имя", 0], [QLineEdit, "Пароль", 0], [QComboBox, ["Администратор", "Клиент"], 0]],
               "Service": [[QLineEdit, "Название услуги", 0]],
               "Applications": [[QDateEdit, "Дата записи", 0], [QLineEdit, "ID пользователя", 0],
                            [QLineEdit, "ID услуги", 0], [QLineEdit, "коментарий", 0],
                            [QDateEdit, "Дата выполнения", 0]]}
