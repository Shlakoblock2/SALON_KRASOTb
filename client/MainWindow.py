...
from client.ui_main import Ui_MainWindow
from client.DataWindow import DataWindow
from client.api.resolver import *
from client.api.statistics import update_statistics

TablesList = ["Users", "Service","Applications"]
